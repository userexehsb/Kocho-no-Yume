...
*
* @help
* スキル(アイテム)ごとにモーションと武器画像を設定できるよ
* 個別設定がない場合の基本モーションも設定できるよ
*
*
*
* ◉ 使い方 ◉
...
* <モーション: 突き, 剣>
*
* 倒れモーションで武器をライフルにするなら
* <モーション: 倒れ, ライフル>
*
* 魔法モーションで武器画像を装備依存にするなら
* <モーション: 魔法, 装備>
*
...
//
this.setSkillMotionKe(action);
};


// スキルモーションのセット
Game_Actor.prototype.setSkillMotionKe = function(action) {
